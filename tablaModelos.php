                ...
                <nav>
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="http://localhost:8080/proy/formularioModelos.php">Regresar</a></li>
								...
								while($fila = sqlsrv_fetch_array($ejecutar)){
									...
									echo'
										<tr>
											<td>'.$id.'</td>
											<td>'.$rfc.'</td>
											<td><a href="editarModelos.php?editar='.$id.'">Editar</a></td>
											<td><a href="tablaModelos.php?borrar='.$id.'">Borrar</a></td>
										</tr>
										';
								} 
							?>
