...
<?php
	...
	if(isset($_POST['actualizar'])){
			...
			$consulta = "UPDATE categorias SET id_categoria ='$actualizar_idProveedor', nombre_categoria='$actualizar_rfc' WHERE id_categoria ='$editar_id'";

			$ejecutar = sqlsrv_query($con, $consulta);

			if($ejecutar){
				echo "<script>alert('Datos actualizados')</script>";
				echo "<script>window.open('tablaCategorias.php', '_self')</script>";
			}else{
